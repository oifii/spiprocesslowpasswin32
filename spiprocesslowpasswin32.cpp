///////////////////////////////////////////////////////////////
// spiprocesslowpasswin32.cpp : Defines the entry point for the application.
//
//lowpass filter
//
...
///////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "spiprocesslowpasswin32.h"
#include "FreeImage.h"
...
#define FRAMES_PER_BUFFER (2048) //#define FRAMES_PER_BUFFER (64) 
...
TCHAR szTitle[1024]={L"spiprocesslowpasswin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spiprocesslowpasswin32class"};				// the main window class name
...
static int lowpassCallback( const void *inputBuffer, void *outputBuffer,
                         unsigned long framesPerBuffer,
                         const PaStreamCallbackTimeInfo* timeInfo,
                         PaStreamCallbackFlags statusFlags,
                         void *userData );
